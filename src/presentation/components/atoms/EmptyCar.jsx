...
export default function EmptyCar({ big }) {
  return (
    <div
      className={
        big
          ? 'flex border-2 border-gray-100 border-dashed gap-5 items-center justify-center h-full'
    ...
    >
      <svg
        ...
        data-name='Layer 1'
        className={big ? 'w-80 h-80' : 'w-full h-full'}
      ...
      <div className='flex flex-col gap-2'>
        <span className='text-xl font-bold'>
          Aún no haz seleccionado algún producto
        </span>
        <span className='text-gray-500'>
          ¿Que estás esperando para comprar?
        </span>
        {big ? (
          <Link
            to={config.routes.auth.home.path}
            className='w-full my-6 font-bold px-4 text-center  disabled:bg-primary-300 duration-150 ease-in-out enabled:hover:scale-105 rounded-full bg-primary-700 border text-white border-white py-1 text-sm cursor-pointer'
          >
            Comprar ahora
          </Link>
        ) : (
